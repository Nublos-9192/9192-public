...
git init -b main
git add .
git commit -m 'Publish 9192 public client kit v1.0.5'
gh auth login
gh repo create <github-owner>/9192-public --public --source . --remote origin --push
gh release create v1.0.5 .\releases\v1.0.5\9192_public_client_kit_v1.0.5.zip .\releases\v1.0.5\release_artifacts.sha256 .\releases\v1.0.5\release_artifacts.sha256.sig .\releases\v1.0.5\9192_release_signing_public.pem --title '9192 public client kit v1.0.5' --notes-file .\releases\v1.0.5\RELEASE.md
~~~
